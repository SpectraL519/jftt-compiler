...
[[nodiscard]] std::string add(const jftt::architecture::register_discriminator reg) noexcept {
    static const std::string instruction{"ADD "};
    return instruction + jftt::architecture::as_string(reg);
}

[[nodiscard]] std::string sub(const jftt::architecture::register_discriminator reg) noexcept {
    static const std::string instruction{"SUB "};
    return instruction + jftt::architecture::as_string(reg);
}

[[nodiscard]] std::string get(const jftt::architecture::register_discriminator reg) noexcept {
    static const std::string instruction{"GET "};
    return instruction + jftt::architecture::as_string(reg);
}

[[nodiscard]] std::string put(const jftt::architecture::register_discriminator reg) noexcept {
    static const std::string instruction{"PUT "};
    return instruction + jftt::architecture::as_string(reg);
}

[[nodiscard]] std::string rst(const jftt::architecture::register_discriminator reg) noexcept {
    static const std::string instruction{"RST "};
    return instruction + jftt::architecture::as_string(reg);
}

[[nodiscard]] std::string inc(const jftt::architecture::register_discriminator reg) noexcept {
    static const std::string instruction{"INC "};
    return instruction + jftt::architecture::as_string(reg);
}

[[nodiscard]] std::string dec(const jftt::architecture::register_discriminator reg) noexcept {
    static const std::string instruction{"DEC "};
    return instruction + jftt::architecture::as_string(reg);
}

[[nodiscard]] std::string shl(const jftt::architecture::register_discriminator reg) noexcept {
    static const std::string instruction{"SHL "};
    return instruction + jftt::architecture::as_string(reg);
}

[[nodiscard]] std::string shr(const jftt::architecture::register_discriminator reg) noexcept {
...
[[nodiscard]] std::string strk(const jftt::architecture::register_discriminator reg) noexcept {
    static const std::string instruction{"STRK "};
    return instruction + jftt::architecture::as_string(reg);
}

[[nodiscard]] std::string jumpr(const jftt::architecture::register_discriminator reg) noexcept {
